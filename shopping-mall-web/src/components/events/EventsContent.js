...
import 'jspdf-autotable'; // Add this import for table support
    ...
    const generateAndDownloadPDF = async (event) => {
        try {
            ...
            if (event.bannerImage) {
                const imgData = await fetch(URL.createObjectURL(event.bannerImage))
                    .then(res => res.blob());
        ...
        <div className="p-6">
            ...
            {selectedImage && (
                <Modal onClose={handleCloseModal}>
                    <img src={URL.createObjectURL(selectedImage)} alt="Event Banner" className="max-w-full h-auto mx-auto" />
                </Modal>
            )}
