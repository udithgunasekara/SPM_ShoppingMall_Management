...
const PromotionsContent = ({ handleEditPromotion, handleDeletePromotion, setIsPromotionFormOpen }) => {
  ...
  useEffect(() => {
    // Effect runs whenever promotions change
  ...
  const filteredPromotions = promotions.filter(promotion =>
    promotion && promotion.name && promotion.name.toLowerCase().includes(searchTerm.toLowerCase())  // Ensure promotion and name are defined
  );
